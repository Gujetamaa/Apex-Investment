  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        trust: {
          DEFAULT: "var(--color-trust)", // blue-gray-700
          foreground: "var(--color-trust-foreground)", // white
        },
        conversion: {
          DEFAULT: "var(--color-conversion)", // blue-700
          foreground: "var(--color-conversion-foreground)", // white
        },
        growth: {
          DEFAULT: "var(--color-growth)", // green-700
      ...
      boxShadow: {
        'brand-subtle': '0 2px 8px rgba(27, 54, 93, 0.08)',
        'brand-elevated': '0 4px 16px rgba(27, 54, 93, 0.12)',
