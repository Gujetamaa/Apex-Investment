...
const InvestmentStrategies = () => {
  ...
  // Mock investment strategies data
  const investmentStrategies = [
    {
      id: 1,
      name: "Growth-Focused Portfolio",
      description: "Designed for long-term wealth building through equity-heavy allocation targeting high-growth companies and emerging markets.",
      icon: "TrendingUp",
      ...
      idealFor: [
        ...
        "High risk tolerance for maximum growth",
        "Young professionals building wealth",
        "Those comfortable with market volatility"
      ],
      testimonial: {
        quote: "The growth strategy has exceeded my expectations. Despite some volatility, my portfolio has grown significantly over the past 5 years.",
        client: "Hannah Lee",
        role: "Tech Executive"
      }
    },
    {
      ...
      description: "Capital preservation focused with steady income generation through high-grade bonds and dividend-paying securities.",
      icon: "Shield",
      ...
      idealFor: [
        ...
        "Those needing steady income generation",
        "Conservative investors near retirement"
      ],
      testimonial: {
        quote: "Perfect for my retirement planning. Steady returns with minimal stress and excellent downside protection during market turbulence.",
    ...
    {
      id: 3,
      name: "ESG-Integrated Investing",
      description: "Sustainable investing approach combining environmental, social, and governance factors with strong financial performance.",
      icon: "Leaf",
      iconBg: "bg-success/10",
      iconColor: "text-success",
      risk: "Moderate",
      ...
      idealFor: [
        "Values-driven investors seeking impact",
        "Those prioritizing sustainable practices",
        "Millennials and Gen Z investors",
        "Long-term focused sustainable growth"
      ],
      testimonial: {
        quote: "I love that my investments align with my values while still delivering solid returns. The ESG focus gives me peace of mind.",
    ...
    },
    {
      ...
      description: "Optimized for high-net-worth individuals and business owners with sophisticated tax minimization strategies.",
      icon: "Calculator",
      iconBg: "bg-accent/10",
      ...
      idealFor: [
        ...
        "Investors seeking after-tax optimization"
      ],
      testimonial: {
        quote: "The tax efficiency has saved me thousands annually while maintaining strong performance. Perfect for my business owner needs.",
  ...
  const handleFilterChange = (filters) => {
    ...
    const filtered = investmentStrategies?.filter(strategy => {
      ...
      if (filters?.goals) {
        const goalMap = {
          'retirement': [1, 2, 4], // Conservative and Tax-Efficient
          'wealth-building': [1, 3], // Growth and ESG
          'income': [2, 4], // Conservative and Tax-Efficient
          'tax-efficiency': [4], // Tax-Efficient only
          'esg': [3] // ESG only
        };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-6">
              Tailored Investment
              <span className="text-primary block">Approaches</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-card rounded-lg p-6 text-center brand-shadow-subtle">
              <div className="text-2xl font-bold text-primary mb-2">4</div>
              <div className="text-sm text-muted-foreground">Core Strategies</div>
            </div>
            <div className="bg-card rounded-lg p-6 text-center brand-shadow-subtle">
              <div className="text-2xl font-bold text-primary mb-2">9.8%</div>
              <div className="text-sm text-muted-foreground">Avg 5Y Return</div>
            </div>
            <div className="bg-card rounded-lg p-6 text-center brand-shadow-subtle">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                {filteredStrategies?.length} strategies match your criteria
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <span className="font-display font-semibold text-xl text-primary">Meridian</span>
                  <span className="text-xs text-muted-foreground font-medium tracking-wide block">CAPITAL</span>
                </div>
              </div>
              <p className="text-muted-foreground mb-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="/about-apex" className="hover:text-foreground brand-transition">About Meridian</a></li>
